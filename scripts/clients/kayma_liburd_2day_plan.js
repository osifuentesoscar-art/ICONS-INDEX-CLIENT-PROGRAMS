...
const days = [
  {
    ...
    blocks: [
      {
        letter: 'A',
        title: 'CORRECTIVE & ACTIVATION — CONTROL AND ALIGNMENT',
        color: 'gold',
        introLabel: 'Why',
        intro: 'Wakes the glute medius and scapular stabilizers and locks in core bracing before any compound load goes on the bar — the neural precision this population needs before loading. Slot 1 of the ICONS Block Method. No Styku scan, movement screen, or PT note exists for this client, so this block is a general activation primer rather than a finding-specific corrective — that is stated honestly rather than dressed up as targeted corrective work, and it becomes finding-specific once the baseline assessment is on file.',
        exercises: [
      ...
      {
        letter: 'B',
        title: 'PRIMARY COMPOUND — BARBELL BACK SQUAT',
        introLabel: 'Load Target',
        intro: 'Slot 2 — the day\'s main lift and the heaviest work of the session, drawn from the 10 core ICONS Index movements. Coach options, same pattern, all runnable on the studio\'s rack and Olympic bar: Barbell Back Squat (the tracked anchor — this is the lift that gets retested), Front Squat (more upright torso, less lumbar shear), Box Squat (fixed depth when tolerance varies), or Goblet Squat at the 25 lb kettlebell ceiling for a lighter technique day. The anchor stays the anchor: substitute for a session, not for the progression.',
        exercises: [
          { name: 'Barbell Back Squat', sets: '4', reps: '6', load: 'Heavy — 1-2 RIR', tempo: '3-2-1', rest: '2 min', cue: 'Brace before descent, 2-count pause at depth, drive floor away.', flag: 'Cardiac — exhale on exertion, no sustained breath-hold across reps.', rirNote: '2 RIR — primary lift default' },
        ],
      },
      {
        letter: 'C',
        title: 'ACCESSORY — BULGARIAN SPLIT SQUAT',
        color: 'gold',
        introLabel: 'Why This Follows the Squat',
        intro: 'Slot 3 — hypertrophy work supporting the primary, in the same knee-dominant pattern. A primary lift immediately followed by a close accessory in its own pattern is the pairing the Antagonist Rotation Rule explicitly allows; it is the *third* consecutive same-chain lift the rule forbids, which is why the hinge does not sit here (see Block E).',
        exercises: [
          { name: 'Bulgarian Split Squat (DB)', sets: '3+3', reps: '8 ea', load: '25–30 lbs/hand', tempo: '2-1-1', rest: '75s', cue: 'Rear foot elevated, front knee tracks over toes, even tempo both legs.', rirNote: '1 RIR — hypertrophy-priority accessory' },
        ],
      },
      {
        letter: 'D',
        ...
        introLabel: 'Format',
        intro: 'Slot 5 — a second compound in a genuinely different movement pattern from the squat, and the block that breaks the leg-chain run before the hinge. Paired sets: press then pull, 15 seconds between the pair, full rest after. Press options, all studio-available: Incline DB Bench Press (anchor, a core ICONS Index movement), Flat DB Press, Landmine Press, or Standing Barbell Overhead Press. Pull options: Single-Arm DB Row (anchor), Kieser Row, Chest-Supported Row, or Assisted Pull-Up on the machine. Dumbbells cap at 60 lbs/hand in this studio — progression past that moves to the barbell or the Kieser line, not to a heavier dumbbell.',
        exercises: [
          { name: 'Incline DB Bench Press (Paired A1)', sets: '5', reps: '6–8', load: 'Heavy DB — 60 lbs/hand studio ceiling', tempo: '3-1-1', rest: '15s → A2', cue: 'Elbows ~45°, full stretch at bottom, press to lockout.', flag: 'Cardiac — exhale on exertion, no sustained breath-hold.', rirNote: '2 RIR' },
          { name: 'Single-Arm DB Row (Paired A2)', sets: '5', reps: '8/side', load: 'Heavy DB', tempo: '2-1-2', rest: '90s after pair', cue: 'Bench-supported, flat back, drive elbow to hip, full stretch at bottom.', rirNote: '1 RIR' },
          { name: 'Standing Barbell Overhead Press (Paired B1)', sets: '4', reps: '6', load: 'Moderate-Heavy', tempo: '2-1-1', rest: '15s → B2', cue: 'Ribs down, brace hard, press straight overhead.', flag: 'Cardiac — exhale on exertion, no sustained breath-hold.', rirNote: '2 RIR' },
          { name: 'Weighted Pull-Up or Kieser Pulldown (Paired B2)', sets: '4', reps: '6–8', load: 'BW + load, or heavy Kieser stack', tempo: '3-1-2', rest: '90s after pair', cue: 'Full hang to chin over bar, controlled descent.', rirNote: '1 RIR' },
        ],
      },
      {
        letter: 'E',
        title: 'THIRD COMPOUND — INTEGRATION: HINGE-TO-CARRY, CORE & CONDITIONING (HR-CAPPED)',
        color: 'gold',
        introLabel: 'Cardiac-Safe Format — 160 BPM Ceiling',
        intro: 'Slot 6 — the session\'s closer, built as the hinge-to-carry complex the Block Method names: the Romanian Deadlift loads the posterior chain, the suitcase carry then expresses that same braced hinge under load and locomotion, and core and kettlebell work finish it. Energy becomes identity — at a controlled pace, respecting the 160 bpm ceiling throughout. Hinge options: Romanian Deadlift (anchor), Trap Bar RDL, Single-Leg RDL, or Good Morning. Carry options: Suitcase Carry (anchor), Farmer Carry, Front Rack Carry, or a moderate-pace Sled Push. Check the HR monitor between every set in this block — ease pace immediately if approaching 160 bpm.',
        exercises: [
          { name: 'Romanian Deadlift (Barbell)', sets: '4', reps: '6–8', load: 'Heavy — 1-2 RIR', tempo: '3-1-1', rest: '90s', cue: 'Hinge from the hip, bar tracks close, feel hamstring load, stand tall.', flag: 'Cardiac — exhale on exertion, no sustained breath-hold.', rirNote: '2 RIR' },
          ...
          { name: 'Push-Up (Weighted Vest or Tempo, Advanced Variation)', sets: '3', reps: '10–12', load: 'Bodyweight or light vest/plate', tempo: '3-1-1', rest: '45s', cue: 'Full brace, neutral spine, chest to floor. Slow the eccentric to a 3-count for advanced loading — brief effort, minimal HR carryover.' },
  ...
  },
  {
    ...
    blocks: [
      {
        letter: 'A',
        title: 'CORRECTIVE & ACTIVATION — HINGE PRIMER AND ANTI-ROTATION',
        color: 'gold',
        introLabel: 'Why',
        intro: 'Slot 1 — primes the hip hinge pattern and posterior shoulder before the day\'s heaviest lifts, and locks in anti-rotation core control ahead of the loaded carry. As on Day A, this is a general activation primer rather than a finding-specific corrective: no scan, screen, or PT note exists for this client yet.',
        exercises: [
          ...
          { name: 'Face Pull (Band or Kieser)', sets: '2', reps: '15', load: 'Light band', tempo: '2-1-2', rest: '30s', cue: 'Pull to face, elbows high, external rotation at end range.' },
      ...
      },
      {
        ...
        introLabel: 'Load Target',
        intro: 'Slot 2 — the week\'s heaviest resistance work, and a core ICONS Index movement. Full recovery between every set: near-maximal loading, not fatigue accumulation. This block is not affected by the cardiac ceiling the way conditioning is — controlled heavy sets with full rest between them do not sustain heart rate the way continuous circuit work does — but the monitor stays on throughout regardless. Hinge options, all studio-available: Trap Bar Deadlift (the tracked anchor), Conventional Barbell Deadlift, Sumo Deadlift, or Block/Rack Pulls to shorten the range while keeping the load.',
        exercises: [
          { name: 'Trap Bar Deadlift', sets: '4', reps: '5', load: 'Heavy — near-maximal', tempo: '2-0-1', rest: '2 min', cue: 'Neutral spine, symmetric setup, drive floor away hard.', flag: 'Cardiac — exhale on exertion, no sustained breath-hold across reps.', rirNote: '2 RIR — primary lift default, even on a peak day' },
        ],
      },
      {
        letter: 'C',
        title: 'ACCESSORY — BARBELL HIP THRUST',
        color: 'gold',
        introLabel: 'Why This Follows the Deadlift',
        intro: 'Slot 3 — glute-focused hypertrophy supporting the primary hinge. Second consecutive hip-dominant lift, which the Antagonist Rotation Rule permits as a primary-plus-accessory pair; the pattern breaks at Block D before a third could stack.',
        exercises: [
          { name: 'Barbell Hip Thrust', sets: '4', reps: '6–8', load: 'Heavy', tempo: '2-1-2', rest: '90s', cue: 'Upper back on bench, full hip lockout, squeeze glutes hard at top.', flag: 'Cardiac — exhale on exertion, no sustained breath-hold.', rirNote: '1 RIR — hypertrophy-priority accessory' },
        ],
      },
      {
        letter: 'D',
        ...
        introLabel: 'Format',
        intro: 'Slot 5 — the second compound pattern, and the block that breaks the hip-dominant run. Pull leads this session: paired sets, 15 seconds between the pair, full rest after. Pull options: Weighted Pull-Up or Chin-Up (anchor), Assisted Pull-Up on the machine, Kieser Pulldown, or Bent-Over Barbell Row. Press options: Close-Grip Bench Press (anchor), Weighted Dip, Landmine Press, or Standing DB Arnold Press. Dumbbell work caps at 60 lbs/hand in this studio.',
        exercises: [
          { name: 'Weighted Pull-Up or Chin-Up (Paired A1)', sets: '4', reps: '5–6', load: 'BW + load', tempo: '3-1-1', rest: '15s → A2', cue: 'Full hang, chin clears the bar, controlled 3-count descent.', rirNote: '2 RIR' },
          { name: 'Close-Grip Bench Press or Weighted Dip (Paired A2)', sets: '5', reps: '6–8', load: 'Heavy', tempo: '2-1-1', rest: '90s after pair', cue: 'Elbows tucked ~30°, full range, drive to lockout.', flag: 'Cardiac — exhale on exertion, no sustained breath-hold.', rirNote: '2 RIR' },
          { name: 'Bent-Over Barbell Row (Paired B1)', sets: '3', reps: '8', load: 'Heavy', tempo: '2-1-2', rest: '15s → B2', cue: 'Hip hinge, flat back, pull bar to lower ribs.', rirNote: '1 RIR' },
          { name: 'Standing DB Arnold Press (Paired B2)', sets: '4', reps: '8–10', load: 'Moderate', tempo: '2-1-2', rest: '75s after pair', cue: 'Rotate palms in to out through the press, brace throughout.', rirNote: '1 RIR' },
        ],
      },
      {
        letter: 'E',
        title: 'THIRD COMPOUND — INTEGRATION: UNILATERAL LEG, CARRY & CONDITIONING (HR-CAPPED)',
        color: 'gold',
        introLabel: 'Cardiac-Safe Format — 160 BPM Ceiling, Not a HIIT Finisher',
        intro: 'Slot 6 — the closer, pulling the day\'s patterns into one integrated expression: unilateral knee-dominant and unilateral hinge work, then the loaded carry, then a HR-capped conditioning finish. Deliberately steady-state-adjacent, not a HIIT interval finisher — per the cardiac flag the ceiling is 160 bpm and there is no all-out or sprint work anywhere in this program. HR monitor checked explicitly between every round; extend the easy portion of any round rather than pushing pace if approaching the ceiling. Carry options: Farmer Carry (anchor), Suitcase Carry, Front Rack Carry, or a moderate-pace Sled Push.',
        exercises: [
          { name: 'Front Rack Reverse Lunge (DB or BB)', sets: '3+3', reps: '6 ea', load: 'Moderate-Heavy', tempo: '3-1-1, 1s pause at bottom', rest: '75s', cue: 'Step back with control, front knee tracks over toes, pause at depth.', rirNote: '1 RIR' },
          { name: 'Single-Leg RDL (DB)', sets: '3+3', reps: '8 ea', load: 'Moderate — 20–25 lbs/hand', tempo: '3-1-1', rest: '75s', cue: 'Slight bend in standing knee, hinge from the hip, reach toward floor, squeeze glute to return. Free hand may lightly touch a rack or wall for balance early on — advanced target is unassisted. Left leg leads first.', rirNote: '1 RIR' },
          { name: 'Farmer Carry (Both Hands, Heavy DB)', sets: '3', reps: '30–40 yds', load: 'Heavy — 60 lbs/hand studio ceiling', tempo: 'Controlled', rest: '90s', cue: 'Shoulders packed, chest tall, neutral neck. Check HR monitor before the next set — ease pace if approaching 160 bpm.' },
