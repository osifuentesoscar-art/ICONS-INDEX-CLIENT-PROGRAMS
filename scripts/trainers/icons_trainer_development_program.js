  ...
  // ═══════════ DAY 1 — 80% GOLD — PRIMARY STRENGTH ═══════════
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        exercises: [
          { name: 'Barbell or DB Bench Press', insight: 'Trainer Insight: Est 1RM = BW × 0.80 typical advanced baseline. Work at 80% of that.', sets: '4', reps: '4–6', load: '80% Est 1RM', tempo: '3-1-1', rest: '2 min', cue: 'Elbows at 45°. Bar to chest. Full lockout. 3-sec descent is mandatory.', rirNote: '2 RIR — default proximity for a primary lift' },
          { name: 'DB Overhead Press (Standing)', insight: 'Trainer Insight: OHP is the #1 functional overhead indicator for clients 40+', sets: '4', reps: '5–7', load: '80% of 3RM', tempo: '2-1-1', rest: '90s', cue: 'Neutral grip. Press to lockout. Arms alongside ears. Core braced.', rirNote: '2 RIR' },
    ...
    blocks: [
      {
        ...
        intro: 'The hex bar deadlift is the single most important movement in the ICONS system. It builds posterior chain strength and drives bone density — the LIFTMOR RCT\'s actual prescription is >85% 1RM (corrected 8/17/2026 from a rounded "≥80%"), delivered supervised, 2×/week, after a technique-first ramp-in and a risk-stratification screen for fracture history. Your working sets today (87–92% Est 1RM) sit inside that real range, not the old rounded-down one. When you coach this lift, you are delivering a physiological intervention. Load it with that intention.',
        exercises: [
