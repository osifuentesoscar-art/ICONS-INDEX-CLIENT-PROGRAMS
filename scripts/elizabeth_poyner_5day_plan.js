...
const client = {
  ...
  bmr: 1159,
  alstIndex: 5.85, // Week 8 rescan — Not At-Risk (Normal/monitor tier)
};
...
const days = [
  ...
  },
  {
    ...
    intensityPara: 'Thursday is the highest-intensity gym session of the week. Hex bar PR is now 195 lbs × 5 (Est 1RM 228 lbs) — a new all-time record. Wk1 working load: 180 lbs. Rest fully between sets. CNS output is the priority. Every heavy set at ≥80% 1RM is a direct bone-density investment.',
