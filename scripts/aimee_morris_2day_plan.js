...
const baselineNotes = [
  ...
  {
    type: 'green',
    label: 'Creatine — Strongly Indicated',
    body: 'At 48 you sit in the bracket where creatine is the single best-evidenced supplement in this system, and unlike your protein target it needs no bodyweight figure to prescribe: 3\u20135g of creatine monohydrate daily, taken with food, no loading phase. It saturates in about four weeks \u2014 that slower ramp is deliberate, since loading doses commonly cause GI upset and people stop taking it. Insist on plain monohydrate; the other forms are not superior. Well-supported for strength, power and sleep quality, and it only works paired with the training \u2014 creatine without resistance training did not increase lean mass in postmenopausal women over two years.',
  },
  {
    type: 'gold',
    ...
    blocks: [
      {
        ...
        intro: 'Hip hinge needs improvement. This means Aimee is currently bending from the lumbar spine rather than hinging from the hip joint. Under load, this puts direct stress on the stenosis. These drills run before every deadlift set until the hinge is reflexive. Hip hinge cue: push the hips BACK toward the wall behind you, not down toward the floor. Kettlebell Hip-Hinge Hang and Glute Kickback — an isometric hinge-position hold and a targeted hip-extension isolation drill — both reinforce the same hip-hinge/hip-extension quality this block exists to build. This whole block is quality-governed, not RIR-governed: the drills end when the hinge position degrades, never when the muscle fatigues, so no reps-in-reserve target is set on them.',
        exercises: [
          ...
          { name: 'Kettlebell Hip-Hinge Hang (Isometric)', sets: '2', reps: '3-5 controlled breaths (hold)', load: '20 lbs KB', tempo: '—', rest: '30s', cue: 'Hold at the bottom of the hinge position — neutral spine, lats engaged, no eccentric loading. Builds hinge-position control and time-under-tension awareness without adding load stress before the working sets.' },
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: 'Sled Push', sets: '3', reps: '20–30 yd', load: 'Moderate — coach discretion', tempo: 'Aggressive drive', rest: 'Short between rounds', cue: 'Drive aggressively from the hips, short rest between rounds. Horizontal loading — well tolerated even while other patterns are being reintroduced gradually.' },
        ],
      },
    ],
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        exercises: [
          { name: 'Assisted Pull-Up — Neutral Grip', sets: '3', reps: '5–6 reps', load: 'Assist level set', tempo: '3-1-2', rest: '60s', cue: 'LEADS every session — safest grip for spinal stenosis. Full hang at bottom. Chin over bar at top. Controlled 3-second descent. Neutral grip (palms facing each other). Add 1 rep every 2 weeks.', rirNote: '2 RIR — set the assist so the last rep is clean with ~2 left' },
