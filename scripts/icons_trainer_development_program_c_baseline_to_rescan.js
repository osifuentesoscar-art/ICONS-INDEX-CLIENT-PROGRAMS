...
function baselineBattery(dayNumber, contextNote) {
  return {
    ...
    exercises: [
      ...
      { name: 'Dumbbell Farmers Carry', sets: '1–2', reps: 'Max distance/hand load', load: 'Find your working weight', tempo: 'Controlled', rest: '2 min', cue: 'Record the exact weight per hand and distance covered.' },
    ],
  };
}
...
const day1Build = clone(base.days[0]); // 80%
...
const day2Build = clone(base.days[1]); // 90%
...
const day3Build = clone(base.days[2]); // 70%
