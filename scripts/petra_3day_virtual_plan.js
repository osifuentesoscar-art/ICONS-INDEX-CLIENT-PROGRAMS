...
const days = [
  {
    ...
    intensityPara: 'Primary lower-body strength day — hex deadlift and squat patterns carry the week\'s heaviest working loads, with unilateral work directly targeting the force-assessment asymmetry below. Equipment: Dumbbells (heaviest pairs — the hinge and carries here run to 55 lbs/hand) · Kettlebell · Bench or step · Mini-band (optional).',
    ...
    blocks: [
      {
        ...
        exercises: [
          { name: 'Single-Leg Glute Bridge (Left Side)', sets: '2', reps: '12', load: 'Bodyweight', tempo: '2-1-1', rest: '30s', cue: 'Left glute drives, hips level — the priority side per the force assessment.', rirNote: '3+ RIR — technique/submaximal' },
          { name: 'Clamshell (Left Side)', sets: '2', reps: '15', load: 'Bodyweight or light band', tempo: '2-1-1', rest: '30s', cue: 'Hips stacked, heels together, squeeze the left glute med at top.', rirNote: '3+ RIR — technique/submaximal' },
          ...
          { name: 'Lateral Band Walk (Mini-band if available)', sets: '2', reps: '15 ea way', load: 'Band', tempo: 'Controlled', rest: '30s', cue: 'Band above knees. Slight squat, step lateral. Glute medius activation — prevents knee cave under load.', rirNote: '3+ RIR — technique/submaximal' },
        ],
      },
      {
        letter: 'B',
        ...
        exercises: [
          { name: 'Hex Bar Deadlift (or DB Deadlift)', sets: '4', reps: '5', load: 'Wk1: 85 lbs → Wk4: 110 lbs', tempo: '2-1-1', rest: '90s', cue: 'Stand centered in hex bar or DBs at sides. Hips hinge back to grip. Drive floor away, lockout hips at top. Neutral spine throughout. Camera side-on for coach check.', rirNote: '2 RIR' },
        ],
      },
      {
        letter: 'C',
        ...
        exercises: [
          { name: 'Romanian Deadlift (DB)', sets: '3', reps: '8–10', load: '30–40 lbs', tempo: '3-1-1', rest: '75s', cue: 'Hip hinge, soft knee, feel hamstring load. DBs track close to legs. Returns to standing via glute squeeze. Builds hamstring volume to complement the hex bar pattern.', rirNote: '1 RIR — hypertrophy priority' },
        ],
      },
      {
        letter: 'D',
        ...
        intro: 'The day\'s second compound pattern — knee-dominant squatting, rotating off the hinge work above. Camera facing front for goblet squat. Knees should track over the second toe. No inward collapse. Coach will cue depth — aim for thighs parallel or below. If the day calls for a variation, rotate between: a KB goblet squat (your bell, on a lighter day), a DB front squat (two DBs racked at the shoulders), or a box/bench squat to depth. The goblet squat stays the movement we track; on every unilateral option the left leg leads.',
        exercises: [
          { name: 'Goblet Squat (DB or KB)', sets: '4', reps: '8–10', load: '30–40 lbs', tempo: '3-1-1', rest: '90s', cue: 'DB or KB at chest, elbows inside knees at depth. Full depth, drive through heels. Chest tall. Builds the bilateral squat pattern before loading heavier.', rirNote: '2 RIR' },
          { name: 'Bulgarian Split Squat (DB, per leg)', sets: '3+3', reps: '8 ea', load: '20–25 lbs/hand', tempo: '3-1-1', rest: '75s', cue: 'Baseline 20 lbs/hand. Rear foot elevated on bench. Front knee tracks over second toe. Left leg leads first. +2.5 lbs/hand every 2 weeks.', rirNote: '1 RIR — hypertrophy priority' },
        ],
      },
      {
        letter: 'E',
        ...
        exercises: [
          { name: 'Single-Leg RDL (DB)', sets: '3+3', reps: '8 ea', load: '20–25 lbs/hand', tempo: '3-1-1', rest: '60s', cue: 'Baseline 20 lbs/hand. Slight knee bend, hinge from hip, feel hamstring load. Return to standing by squeezing the glute. Left leg leads. +2.5 lbs every 2 weeks.', rirNote: '1 RIR — hypertrophy priority' },
          { name: 'Single-Leg Dumbbell Squat (Step or Bench)', sets: '3+3', reps: '8 ea', load: '20–25 lbs', tempo: '3-1-1', rest: '60s', cue: 'Step on bench, single leg. Lower until opposite foot grazes floor. Drive through heel. Full hip extension at top. Left leg leads.', rirNote: '1 RIR — hypertrophy priority' },
          { name: 'Hip Thrust (DB or Barbell, on Bench)', sets: '3', reps: '12–15', load: '30–45 lbs', tempo: '2-2-1', rest: '60s', cue: 'Upper back on bench, DB or bar on hips. Drive through heels, hold 2 seconds at top. Glute isolation — the key driver of glute hypertrophy.', rirNote: '1 RIR — hypertrophy priority' },
        ],
      },
      {
        letter: 'F',
        ...
        exercises: [
          { name: 'Plank Hold (Elbow)', sets: '3', reps: 'Baseline :45 +10s/wk', load: 'Bodyweight', tempo: '—', rest: '60s', cue: 'Baseline :45. Add 10 seconds per week. Full brace — squeeze glutes, ribs down, neutral neck. Camera side-on so coach can check spine position.', rirNote: 'Hold quality governed — no RIR target' },
          { name: 'Dead Bug', sets: '3', reps: '8 ea side', load: 'Bodyweight', tempo: '3-0-3', rest: '45s', cue: 'Lower back pressed into floor throughout. Slow opposite arm-leg extension. Anti-extension core. Key stability work for deadlift and squat patterns.', rirNote: 'Hold quality governed — no RIR target' },
          { name: 'KB Swing (Hinge Power)', sets: '4', reps: '10', load: 'Moderate KB', tempo: 'Explosive', rest: '60s', cue: 'Hip hinge back, drive hips forward hard. Not a squat — the power comes entirely from the hip snap. Arms are ropes. Rate of force development.', rirNote: 'Speed governed — stop when bar/ball speed drops' },
        ],
      },
    ],
    ...
    blocks: [
      {
        ...
        exercises: [
          { name: 'Right-Hand Isometric Squeeze', sets: '3', reps: '10s hold', load: 'Ball or rolled towel — max squeeze', tempo: 'Hold', rest: '30s', cue: 'Right hand only. Squeeze hard for 10 seconds, full rest between — wake the pathway, not fatigue it.', rirNote: 'Hold quality governed — no RIR target' },
        ],
      },
      {
        letter: 'B',
        ...
        exercises: [
          { name: 'DB Bench Press (Flat)', sets: '4', reps: '10–12', load: 'Wk1: 15 → Wk4: 22.5 lbs/hand', tempo: '3-1-1', rest: '75s', cue: 'Baseline 15 lbs/hand. Elbows at 45°. Full range — DBs to chest level. Squeeze at top. Add 2.5 lbs/hand every 2 weeks. Target 22.5 lbs by Week 4.', rirNote: '2 RIR' },
        ],
      },
      {
        letter: 'C',
        ...
        exercises: [
          { name: 'Incline DB Press (30–45°)', sets: '3', reps: '10–12', load: '12.5–17.5 lbs/hand', tempo: '3-1-1', rest: '75s', cue: 'Upper chest emphasis. Slightly lighter than flat press. Builds the upper chest and anterior delt that complement the flat press.', rirNote: '1 RIR — hypertrophy priority' },
          { name: 'DB Single-Arm Row', sets: '4', reps: '8–10 ea', load: 'R: 30 lbs / L: 35 lbs Wk1', tempo: '3-1-2', rest: '60s', flag: 'Right arm leads — 14.8% neural delay protocol', cue: 'Force data: LEFT grip 78 lb (98th %ile), RIGHT 55 lb (65th %ile), 29.5% asymmetry. RIGHT arm leads each set and starts 5 lbs lighter than left. RIGHT arm: 3s isometric squeeze at top every rep to address the 14.8% neural delay. Left arm: normal tempo. Add 2.5 lbs/hand every 2 weeks.', rirNote: '1 RIR — hypertrophy priority' },
          { name: 'Push-Up Progression', sets: '3', reps: 'Max (target 8–10 full)', load: 'Bodyweight', tempo: '3-0-1', rest: '90s', cue: 'Baseline 10 assisted. Week 1: incline push-ups (hands on bench) or first full floor attempts. Week 3: full push-ups from the floor. Record reps each set every session.', rirNote: '1 RIR — hypertrophy priority' },
        ],
      },
      {
        letter: 'D',
        ...
        exercises: [
          { name: 'DB Overhead Press', sets: '4', reps: '10–12', load: 'Wk1: 15 → Wk4: 22.5 lbs/hand', tempo: '2-1-1', rest: '75s', cue: 'Baseline 15 lbs/hand. Seated or standing. Press overhead, arms alongside ears. Core rigid. Progress same rate as bench press.', rirNote: '2 RIR' },
          { name: 'KB Renegade Row', sets: '3', reps: '8 ea side', load: 'KB or 15–20 lbs DB', tempo: '2-1-2', rest: '60s', cue: 'Push-up position, one hand on KB. Row one arm while holding plank with the other. Builds lat and mid-back strength without a cable. RIGHT arm: 3s hold at top (neural delay protocol).', rirNote: '1 RIR — hypertrophy priority' },
          { name: 'DB Rear Delt Fly (Bent-Over)', sets: '3', reps: '12–15', load: '8–12 lbs', tempo: '2-1-3', rest: '30s', cue: 'Hinge forward, arms hanging. Raise DBs out to shoulder height, 3-second hold at top. Rear delt and mid-back. Replaces banded face pull — no anchor needed. 3s hold creates the same stimulus.', rirNote: '1 RIR — hypertrophy priority' },
          { name: 'Med Ball Overhead Slam', sets: '3', reps: '10', load: '8–10 lbs med ball', tempo: 'Explosive', rest: '20s', cue: 'Raise overhead, slam to floor with full force. Shoulders and lats fire hard at the top — trains the same scapular retraction pattern as a pull-apart but adds power expression. No band needed.', rirNote: 'Speed governed — stop when bar/ball speed drops' },
        ],
      },
      {
        letter: 'E',
        ...
        exercises: [
          { name: 'Farmer Carry (Both Hands, DB)', sets: '4', reps: '30–35 yds', load: 'Wk1: L 40 lbs / R 35 lbs', tempo: 'Controlled', rest: '90s', flag: 'Right hand 5 lbs lighter — grip asymmetry protocol', cue: 'Force data shows right grip 29.5% weaker. Start RIGHT hand 5 lbs lighter than left (L:40, R:35) to avoid right-side compensation. Raise right-side load by 5 lbs per week when sets complete cleanly. Target load symmetry by Week 4.', rirNote: 'Distance & quality governed — no RIR target' },
          { name: 'Suitcase Carry (Single Arm)', sets: '3', reps: '25 yds ea', load: '30–35 lbs', tempo: 'Controlled', rest: '60s', flag: 'RIGHT arm leads — grip asymmetry protocol', cue: 'RIGHT arm carries first each set, per the right-arm-priority protocol. Resist lateral lean. Anti-lateral flexion core. Reveals left-right imbalance under load.', rirNote: 'Distance & quality governed — no RIR target' },
          { name: 'Plank Hold (Elbow)', sets: '3', reps: 'Baseline :45 +10s/wk', load: 'Bodyweight', tempo: '—', rest: '60s', cue: 'Baseline :45. Add 10 seconds per week. Target 1:00 by Week 2, 1:20 by Week 4.', rirNote: 'Hold quality governed — no RIR target' },
          { name: 'Med Ball Rotational Press', sets: '3', reps: '10 ea side', load: '8 lbs med ball', tempo: '2-1-2', rest: '45s', cue: 'Hold med ball at chest, step laterally and press out while resisting trunk rotation. No anchor needed. Same anti-rotation stimulus as Pallof press using the med ball as resistance.', rirNote: 'Hold quality governed — no RIR target' },
        ],
      },
    ],
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        exercises: [
          { name: 'KB Swing (Two-Hand)', sets: '5', reps: '10', load: 'Moderate KB', tempo: 'Explosive', rest: '60s', cue: 'Hip hinge back, explosive hip snap forward. The KB floats to shoulder height from hip drive alone. This is the foundational power exercise in this program.', rirNote: 'Speed governed — stop when bar/ball speed drops' },
          { name: 'KB Swing (Single-Arm, alternating)', sets: '3', reps: '8 ea hand', load: 'Moderate KB', tempo: 'Explosive', rest: '60s', cue: 'Same mechanics as two-hand. Release and switch at the top. Challenges rotational core stability. Build from two-hand base before loading this.', rirNote: 'Speed governed — stop when bar/ball speed drops' },
          { name: 'KB Goblet Squat (Pulse at Bottom)', sets: '3', reps: '10 + 5 pulse', load: 'Moderate KB', tempo: '3-1-1+pulse', rest: '60s', cue: 'Full squat, then pulse 3 inches at bottom for 5 reps. The pulse creates time under tension at the most mechanically demanding position.', rirNote: 'Speed governed — stop when bar/ball speed drops' },
          { name: 'KB Clean (to Rack Position)', sets: '3', reps: '6 ea side', load: 'Moderate KB', tempo: 'Explosive', rest: '75s', cue: 'Hinge back, pull KB up close to body, punch elbow under to rack at shoulder. Explosive pull from the floor. Builds power and shoulder stability simultaneously.', rirNote: 'Speed governed — stop when bar/ball speed drops' },
        ],
      },
      {
        letter: 'C',
        ...
        exercises: [
          { name: 'Med Ball Chest Pass (Wall)', sets: '4', reps: '8', load: '8–12 lbs', tempo: 'Explosive', rest: '45s', cue: 'Stand 3–4 feet from wall. Catch and immediately fire back. No pause. Trains horizontal pushing power and reflexive upper body strength.', rirNote: 'Speed governed — stop when bar/ball speed drops' },
          { name: 'Med Ball Slam', sets: '4', reps: '8', load: '8–12 lbs', tempo: 'Explosive', rest: '45s', cue: 'Raise overhead (full extension), slam to floor with full force. Total-body power from shoulders through hips. Excellent metabolic and neural stimulus.', rirNote: 'Speed governed — stop when bar/ball speed drops' },
          { name: 'Med Ball Rotational Throw (Wall)', sets: '3', reps: '8 ea side', load: '8–10 lbs', tempo: 'Explosive', rest: '45s', cue: 'Stand side-on to wall, rotate through trunk and throw across body. Trains transverse plane power and thoracic rotation under load.', rirNote: 'Speed governed — stop when bar/ball speed drops' },
          { name: 'Med Ball Push-Up (Hands on Ball)', sets: '2', reps: '8–10', load: '1 med ball', tempo: '3-0-1', rest: '45s', cue: 'Both hands on the med ball for a destabilized push-up. Challenges shoulder stability and core. Regression: one hand on ball, one on floor.', rirNote: '3+ RIR — technique/submaximal' },
        ],
      },
      {
        letter: 'D',
        ...
        exercises: [
          { name: 'C1  DB Deadlift (Suitcase Style)', sets: '3', reps: '5', load: 'Wk1: 80 lbs → Wk4: 100 lbs total (40 → 50 lbs per hand)', tempo: '2-1-1', rest: '15s rest then C2', cue: 'Hip hinge, one DB each side like a suitcase. Heavy — near Day 1\'s Hex Bar Deadlift load. Then 15s rest, straight into C2.', rirNote: '2 RIR — cluster pairing, both lifts' },
          { name: 'C2  DB Overhead Press', sets: '3', reps: '8', load: 'Working load', tempo: '2-1-1', rest: '90s', cue: '15 lbs/hand Wk1. Same baseline as Day 2. Full 90s rest after C2 before next cluster. The deadlift pre-fatigues the posterior chain, making the OHP pure upper.', rirNote: '2 RIR — cluster pairing, both lifts' },
          { name: 'D1  DB Goblet Squat', sets: '3', reps: '8', load: 'Wk1: 40 lbs → Wk4: 50 lbs', tempo: '3-1-1', rest: '15s rest then D2', cue: 'Heaviest goblet squat of the week — above Day 1\'s working load. Push load here. Then 15s, into D2.', rirNote: '2 RIR — cluster pairing, both lifts' },
          { name: 'D2  DB Bench Press', sets: '3', reps: '10', load: 'Working load', tempo: '3-1-1', rest: '90s', cue: '15 lbs/hand Wk1. Rest 90s after D2. Squat pre-loads the full body, making the bench a true upper test under fatigue.', rirNote: '2 RIR — cluster pairing, both lifts' },
        ],
      },
      {
        letter: 'E',
        ...
        exercises: [
          { name: 'Elbow Plank Hold', sets: '3', reps: 'Baseline :45 +10s/wk', load: 'Bodyweight', tempo: '—', rest: '60s', cue: 'Third plank exposure this week. All three sessions build plank time simultaneously. :45 baseline → 1:00 Wk2 → 1:10 Wk3 → 1:20 Wk4.', rirNote: 'Hold quality governed — no RIR target' },
          { name: 'Dead Bug (Anti-Extension Core)', sets: '3', reps: '8 ea side', load: 'Bodyweight', tempo: '3-0-3', rest: '45s', cue: 'Lower back to floor throughout. Full extension arm and leg. Anti-extension core endurance for deadlift and carry strength.', rirNote: 'Hold quality governed — no RIR target' },
          { name: 'Med Ball Rotational Hold', sets: '2', reps: '10 ea side', load: '8 lbs med ball', tempo: '2-1-2', rest: '30s', cue: 'Hold med ball extended, rotate trunk and resist. Anti-rotation core. Third exposure this week. No band needed — med ball as resistance.', rirNote: 'Hold quality governed — no RIR target' },
        ],
      },
    ],
