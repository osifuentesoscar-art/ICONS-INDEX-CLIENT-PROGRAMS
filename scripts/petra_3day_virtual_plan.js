    ...
    blocks: [
      {
        ...
        intro: '15 lbs/hand for both chest press and OHP. Wk1 keeps that load for 10–12 reps. Progress +2.5 lbs/hand every 2 weeks. Chest press target is 22.5 lbs/hand by Week 4. OHP target is 22.5 lbs/hand by Week 4. These are realistic intermediary jumps from a 15 lb working weight.',
        exercises: [
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: 'Suitcase Carry (Single Arm, alternating)', sets: '3', reps: '25 yds ea', load: '30–35 lbs', tempo: 'Controlled', rest: '60s', cue: 'One arm at a time. Resist lateral lean. Anti-lateral flexion core. Reveals left-right imbalance under load. Alternate starting arm each set.' },
